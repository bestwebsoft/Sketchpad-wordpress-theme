...
function sketchpad_script() {
	...
	$wp_styles->add_data( 'sketchpad-ie', 'conditional', 'lt IE 9' );
	global $wp_scripts;
	wp_enqueue_script( 'sketchpad-ie-html5', get_template_directory_uri() . '/js/html5.js' );
	$wp_scripts->add_data( 'sketchpad-ie-html5', 'conditional', 'lt IE 9' );
	wp_enqueue_script( 'sketchpad-ie-IE9', get_template_directory_uri() . '/js/IE9.js' );
	$wp_scripts->add_data( 'sketchpad-ie-IE9', 'conditional', 'lt IE 9' );
